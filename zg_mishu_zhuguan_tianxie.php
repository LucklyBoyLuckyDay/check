...
<form action="save_to_db_zg_mishu_zhuguan.php" method="get">
<?php
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、完成每次基地部长会、主管会会议记录。 </div><div class="content_right">（记录无误：7分——未记录：0分）</div></td><td class="score"><input type="text" name="a1"/></td>

</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">2、完成每次综合管理部例会会议记录</div><div class="content_right">（记录无误：7分——未记录：0分）</div></td><td class="score"><input type="text" name="a2"/></td>
</tr>

<tr>

	<td colspan ="4" class="check_content"><div class="content_left">3、会前提醒、会议追踪。</div><div class="content_right">（无误：7分——两次及两次以上错误：0分）</div></td><td class="score"><input type="text" name="a3"/></td>
</tr>

<tr>

	<td colspan ="4" class="check_content"><div class="content_left">4、离职员工员工档案的制作</div><div class="content_right">（制作精致：9分——未制作：0分）</div></td><td class="score"><input type="text" name="a4"/></td>
</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">5、资料整理以及汇总。</div><div class="content_right">（汇总详尽：7分——未整理收集：0分）</div></td><td class="score"><input type="text" name="a5"/></td>
</tr>
<tr>
