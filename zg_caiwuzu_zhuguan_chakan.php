...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、每月服务时间与人数核对无误。</div><div class="content_right">（无误：7分——三次及三次以上：0分）</div></td><td class="score">
	<?php
		if(isset($a1)&&$a1!=null){
			echo "$a1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、各部门领取物资记录准确。</div><div class="content_right">（无误：7分——三次及三次以上：0分）</div></td><td class="score">
	<?php
		if(isset($a2)&&$a2!=null){
			echo "$a2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、基地报销严格审查。</div><div class="content_right">（无误：7分——两次及两次以上错误：0分）</div></td><td class="score">
	<?php
		if(isset($a3)&&$a3!=null){
			echo "$a3";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">4、细致做好每一次基地采购以及日常采购。</div><div class="content_right">（无误：7分——两次及两次以上错误：0分）</div></td><td class="score">
	<?php
		if(isset($a4)&&$a4!=null){
			echo "$a4";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">5、认真做好每月报销分析。</div><div class="content_right">（分析良好：7分——未分析：0分）</div></td><td class="score">
	<?php
		if(isset($a5)&&$a5!=null){
			echo "$a5";
		}
