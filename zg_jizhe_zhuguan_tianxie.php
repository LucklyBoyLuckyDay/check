...
<form action="save_to_db_zg_jizhe_zhuguan.php" method="get">
<?php
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、根据基地活动撰写相关新闻。</div><div class="content_right">（新闻即时：8分——未写新闻：0分）</div></td><td class="score"><input type="text" name="a1"/></td>

</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">2、微博空间动态的更新。 </div><div class="content_right">（动态更新：8分——5天以上未更新：0分）</div></td><td class="score"><input type="text" name="a2"/></td>
</tr>

<tr>

	<td colspan ="4" class="check_content"><div class="content_left">3、纪律文化月和元旦晚会报纸的制作。</div><div class="content_right">（高质高量完成：8分——未做报纸：0分）</div></td><td class="score"><input type="text" name="a3"/></td>
</tr>

<tr>

	<td colspan ="4" class="check_content"><div class="content_left">4、外出采集新闻素材的整理。</div><div class="content_right">（素材得当：8分——未收集素材：0分）</div></td><td class="score"><input type="text" name="a4"/></td>
</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">5、每月做好本组总结，透彻分析本月工作。</div><div class="content_right">（总结良好：8分——未总结：0分）</div></td><td class="score"><input type="text" name="a5"/></td>
</tr>
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、值班期间保证值班室的卫生纪律。</div><div class="content_right">（纪律卫生良好：8分——纪律和卫生均不好：0分）</div></td><td class="score"><input type="text" name="c1"/></td>
</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">2、值班期间严禁吃饭等影响值班室形象的不良行为。</div><div class="content_right">（行为良好：8分——行为不好：0分）</div></td><td class="score"><input type="text" name="c2"/></td>
</tr>
