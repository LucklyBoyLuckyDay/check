...
//http://localhost/kaohe_web/table_html_chakan/zg_caiwuzu_zhuguan.php?a1=&a2=&a3=&a4=&a5=&a6=&b1=&b2=&b3=&c1=&c2=&c3=&d1=&d2=&d3=#
...
/**************END**************/
$total_score=$a1+$a2+$a3+$a4+$a5+$a6+$b1+$b2+$b3+$c1+$c2+$c3+$d1+$d2+$d3;
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、对各个部门值班情况进行督察记录。</div><div class="content_right">（按时督察：7分——未督察：0分）</div></td><td class="score">
	<?php
		if(isset($a1)&&$a1!=null){
			echo "$a1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、对各个部门文化、纪律、卫生督察。</div><div class="content_right">（全面督察：7分——未督察：0分）</div></td><td class="score">
	<?php
		if(isset($a2)&&$a2!=null){
			echo "$a2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、每次督察均携带并请值班员填写督察记录表。 </div><div class="content_right">（填写：7分——两次及两次以上未写：0分）</div></td><td class="score">
	<?php
		if(isset($a3)&&$a3!=null){
			echo "$a3";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">4、每月整合本月督察中出现的问题并及时更正。</div><div class="content_right">（分析良好：7分——未分析：0分）</div></td><td class="score">
	<?php
		if(isset($a4)&&$a4!=null){
			echo "$a4";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">5、每本对话基地的制备和整理。</div><div class="content_right">（准备充分、制作精美：7分——未整理：0分）</div></td><td class="score">
	<?php
		if(isset($a5)&&$a5!=null){
			echo "$a5";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">6、每月做好本组总结，透彻分析本月工作。</div><div class="content_right">（总结良好：7分——未总结：0分）</div></td><td class="score">
	<?php
		if(isset($a6)&&$a6!=null){
			echo "$a6";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、按时参加基地主管会议。</div><div class="content_right">（全勤：6分——缺席两次及两次以上：0分）</div></td><td class="score">
	<?php
		if(isset($b1)&&$b1!=null){
			echo "$b1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、准时参加本部门会议。</div><div class="content_right">（全勤：6分——缺席两次及两次以上：0分）</div></td><td class="score">
	<?php
		if(isset($b2)&&$b2!=null){
			echo "$b2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、每月1号按时召开资产主管交流会。</div><div class="content_right">（顺利召开会议：6分——未召开会议：0分）</div></td><td class="score">
	<?php
		if(isset($b3)&&$b3!=null){
			echo "$b3";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、与组员良好沟通，并交接工作顺利。</div><div class="content_right">（沟通良好：6分——未沟通：0分）</div></td><td class="score">
	<?php
		if(isset($d2)&&$d2!=null){
			echo "$d2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、与各部门资产主管经常沟通交流。</div><div class="content_right">（沟通良好：6分——未沟通：0分）</div></td><td class="score">
	<?php
		if(isset($d3)&&$d3!=null){
			echo "$d3";
		}
