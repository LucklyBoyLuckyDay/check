...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、各部门安全检查并记录。</div><div class="content_right">（认真检查：8分 ——未检查：0分）</div></td><td class="score">
	<?php
		if(isset($a1)&&$a1!=null){
			echo "$a1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、各部门固定资产的核实并记录。</div><div class="content_right">（认真核实：8分——未核实：0分）</div></td><td class="score">
	<?php
		if(isset($a2)&&$a2!=null){
			echo "$a2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、携带固定资产登记表并记录。</div><div class="content_right">（记录无误：7分——未携带：0分）</div></td><td class="score">
	<?php
		if(isset($a3)&&$a3!=null){
			echo "$a3";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">4、及时发现安全隐患，协助值班人员进行解决。</div><div class="content_right">（成功解决：7分——未解决：0分）</div></td><td class="score">
	<?php
		if(isset($a4)&&$a4!=null){
			echo "$a4";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">5、每月做好本组总结，透彻分析本月工作。 </div><div class="content_right">（分析良好：7分——未分析：0分）</div></td><td class="score">
	<?php
		if(isset($a5)&&$a5!=null){
			echo "$a5";
		}
