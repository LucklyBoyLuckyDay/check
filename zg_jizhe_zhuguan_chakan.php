...
$total_score=$a1+$a2+$a3+$a4+$a5+$b1+$b2+$c1+$c2+$c3+$d1+$d2+$d3;
...
<tr>
	...
	<td class="tb1_header">考核部门</td><td class="tb1_header">综合管理部记者团</td><td class="tb1_header">考核年月</td><td class="tb1_header"id="display_check_date"><!--2016.3.10-2016.4.10--></td>
</tr>
<tr>
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、根据基地活动撰写相关新闻。</div><div class="content_right">（新闻即时：8分——未写新闻：0分）</div></td><td class="score">
	<?php
		if(isset($a1)&&$a1!=null){
			echo "$a1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、微博空间动态的更新。 </div><div class="content_right">（动态更新：8分——5天以上未更新：0分）</div></td><td class="score">
	<?php
		if(isset($a2)&&$a2!=null){
			echo "$a2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、纪律文化月和元旦晚会报纸的制作。</div><div class="content_right">（高质高量完成：8分——未做报纸：0分）</div></td><td class="score">
	<?php
		if(isset($a3)&&$a3!=null){
			echo "$a3";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">4、外出采集新闻素材的整理。</div><div class="content_right">（素材得当：8分——未收集素材：0分）</div></td><td class="score">
	<?php
		if(isset($a4)&&$a4!=null){
			echo "$a4";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">5、每月做好本组总结，透彻分析本月工作。</div><div class="content_right">（总结良好：8分——未总结：0分）</div></td><td class="score">
	<?php
		if(isset($a5)&&$a5!=null){
			echo "$a5";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、按时参加基地主管会议。</div><div class="content_right">（全勤：8分——缺席两次及两次以上：0分）</div></td><td class="score">
	<?php
		if(isset($b1)&&$b1!=null){
			echo "$b1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、准时参加本部门会议。</div><div class="content_right">（全勤：8分——缺席两次及两次以上：0分）</div></td><td class="score">
	<?php
		if(isset($b2)&&$b2!=null){
			echo "$b2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">---</div><div class="content_right">---</div></td><td class="score">
	<?php
	/*	if(isset($b3)&&$b3!=null){
			echo "$b3";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、值班期间保证值班室的卫生纪律。</div><div class="content_right">（纪律卫生良好：8分——纪律和卫生均不好：0分）</div></td><td class="score">
	<?php
		if(isset($c1)&&$c1!=null){
			echo "$c1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、值班期间严禁吃饭等影响值班室形象的不良行为。</div><div class="content_right">（行为良好：8分——行为不好：0分）</div></td><td class="score">
	<?php
		if(isset($c2)&&$c2!=null){
			echo "$c2";
		}
...
<tr>
	...
	<td rowspan="3" class="zhiban">其它</td><td colspan ="4" class="check_content"><div class="content_left">1、积极参加基地、部门举办的各类活动。</div><div class="content_right">（积极参与各项活动：7分——消极对待各项活动：0分）</div></td><td class="score">
	<?php
		if(isset($d1)&&$d1!=null){
			echo "$d1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、与组员良好沟通，并交接工作顺利。</div><div class="content_right">（沟通良好：7分——未沟通：0分）</div></td><td class="score">
	<?php
		if(isset($d2)&&$d2!=null){
			echo "$d2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、与各部门资产主管经常沟通交流。</div><div class="content_right">（沟通良好：7分——未沟通：0分）</div></td><td class="score">
	<?php
		if(isset($d3)&&$d3!=null){
			echo "$d3";
		}
...
<!--$zu_zhang_score+$zg_zhuguan_random_score;-->
<!--<div class="zu_zhang_score">
组员为组长评分：<?php echo "$zu_zhang_score";?>
</div>
<div class="zg_zhuguan_random_score">
组长互评评分：<?php echo "$zg_zhuguan_random_score";?>
</div>-->
...
{
	//echo "<div class=\"zuzhang_remark\"><h4>组员为组长评语($display_name[$i])</h4>$display_zuzhang_remark[$i]</div>";	
} 
?>
