...
<tr>
	...
	<td class="tb1_header">考核部门</td><td class="tb1_header">综合管理部秘书组</td><td class="tb1_header">考核年月</td><td class="tb1_header"id="display_check_date"><!--2016.3.10-2016.4.10--></td>
</tr>
<tr>
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、完成每次基地部长会、主管会会议记录。 </div><div class="content_right">（记录无误：7分——未记录：0分）</div></td><td class="score">
	<?php
		if(isset($a1)&&$a1!=null){
			echo "$a1";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">2、完成每次综合管理部例会会议记录</div><div class="content_right">（记录无误：7分——未记录：0分）</div></td><td class="score">
	<?php
		if(isset($a2)&&$a2!=null){
			echo "$a2";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">3、会前提醒、会议追踪。</div><div class="content_right">（无误：7分——两次及两次以上错误：0分）</div></td><td class="score">
	<?php
		if(isset($a3)&&$a3!=null){
			echo "$a3";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">4、离职员工员工档案的制作</div><div class="content_right">（制作精致：9分——未制作：0分）</div></td><td class="score">
	<?php
		if(isset($a4)&&$a4!=null){
			echo "$a4";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">5、资料整理以及汇总。</div><div class="content_right">（汇总详尽：7分——未整理收集：0分）</div></td><td class="score">
	<?php
		if(isset($a5)&&$a5!=null){
			echo "$a5";
		}
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left"><!--3、每月1号按时召开资产主管交流会。-->---</div><div class="content_right"><!--（顺利召开会议：7分——未召开会议：0分）-->---</div></td><td class="score">
	<?php
		/*if(isset($b3)&&$b3!=null){
			echo "$b3";
		}
