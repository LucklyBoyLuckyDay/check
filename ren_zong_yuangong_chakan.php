...
<style>
	...
	.zhuguan_remark,.buzhang_advice,.self_remark,.check_advice{
...
print_r($row);
echo "</pre>";*/
//http://localhost/kaohe_web/table_html_chakan/ren_zong_yuangong.php?a1=&a2=&a3=&a4=&a5=&a6=&a7=&b1=&b2=&b3=&b4=&c1=&c2=&c3=&d1=&d2=&d3=&e1=&e2=&e3=&f=&g=&h=&i=&j=&k=&l=#
$a1=$row['a1'];
$a2=$row['a2'];
$a3=$row['a3'];
$a4=$row['a4'];
...
<!-- ------------------------------------------------------------------ -->
<tr>
	<td rowspan ="21" class="work_weight">工作任务</td><td rowspan="7" class="zhiban"class="zhiban">值班</td><td class="work_weight" rowspan="7">10%</td><td class="check_content_tb1" colspan="2" >1.迟到或早退十五分钟及以上扣2分/次。</td>
...
<tr>
	<td class="check_content_tb1" colspan="2">7.此项基本分为10分，无加分，累计不低于0分。</td><td class="score">
...
<!-- ------------------------------------------------------------------ -->
<tr>
	<td rowspan="3"class="zhiban">基地主管会</td><td class="work_weight" rowspan="3">10%</td><td class="check_content_tb1" colspan="2">1.参加基地主管会加2分/次。</td>
	<td class="score">
	<?php
...
<tr>
	<td class="check_content_tb1" colspan="2">2.会上积极发言加2分/次。</td>
	<td class="score">
	<?php
...
<tr>
	<td class="check_content_tb1" colspan="2">3.此项基本分为0分，累计不超过10分。</td>
	<td class="score">
	<?php
...
<!-- ------------------------------------------------------------------ -->
<tr>
	<td rowspan="3"class="zhiban">其它任务</td><td class="work_weight" rowspan="3">10%</td>
	<td class="check_content_tb1" colspan="2">1.按时按量完成基地上级交待的任务2分。</td>
	<td class="score">
	<?php
...
<tr>
	<td rowspan ="12" class="work_weight">工作态度</td><td rowspan="4"class="zhiban">积极性</td><td class="work_weight" rowspan="4" >8%</td><td class="check_content">1.工作一贯积极主动，做事从来不需要上级督促。</td><td>7-8分</td>
...
<tr>
	<td rowspan="4"class="zhiban">责任心</td><td class="work_weight" rowspan="4">8%</td><td class="check_content">1.工作十分负责，除了本职工作，还非常关心其他工作。</td><td>7-8分</td>
	<td class="score" rowspan="4">
	<?php
...
<tr>
	<td rowspan="4"class="zhiban">协作性</td><td class="work_weight" rowspan="4">8%</td><td class="check_content">1.能够主动配合、帮助同事和其他部门开展工作。</td>
	<td>7-8分</td>
	<td class="score" rowspan="4">
	<?php
...
<!-- ---------------工作能力--------------------------------------------------- -->
<tr>
	<td rowspan ="13" class="work_weight">工作能力</td><td rowspan="4"class="zhiban">执行力</td><td class="work_weight" rowspan="4">8%</td><td class="check_content">1.没有顶撞上级现象，能完全按上级要求完成工作。</td><td>7-8分</td>
	<td class="score" rowspan="4">
	<?php
...
<tr>
	<td rowspan="3"class="zhiban">计划性</td><td class="work_weight" rowspan="3">6%</td><td class="check_content">1.所有工作有计划性，对工作内容、时间、数量、程序安排合理、有效。</td><td>5-6分</td>
	<td class="score" rowspan="3">
	<?php
...
<tr>
	<td rowspan="3"class="zhiban">工作量</td><td class="work_weight" rowspan="3">6%</td><td class="check_content">1.工作品质高，与工作标准和目标一致，工作过程准确性高、几乎无反复工作。</td><td>5-6分</td>
	<td class="score" rowspan="3">
	<?php
...
<!-- <input type="submit" value="保存"/>
	...
	<div class="zhuguan_remark"><h4>主管评语</h4><?php	echo "$zhuguan_remark";?></div>
	<div class="buzhang_advice"><h4>部长评语</h4><?php	echo "$buzhang_advice";?></div>
	<div class="self_remark"><h4>员工意见</h4><?php echo "$self_remark";?></div>
