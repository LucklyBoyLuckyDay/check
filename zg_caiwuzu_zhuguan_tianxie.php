...
财务组主管考核评分表
 ...
 <form action="save_to_db_zg_caiwu_zhuguan.php" method="get">
<?php
...
<tr>
	...
	<td class="tb1_header">考核部门</td><td class="tb1_header">综合管理部财务组</td><td class="tb1_header">考核年月</td><td class="tb1_header"id="display_check_date"><!--2016.3.10-2016.4.10--></td>
</tr>
<tr>
...
<tr>
	...
	<td colspan ="4" class="check_content"><div class="content_left">1、每月服务时间与人数核对无误。</div><div class="content_right">（无误：7分——三次及三次以上：0分）</div></td><td class="score"><input type="text" name="a1"/></td>

</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">2、各部门领取物资记录准确。</div><div class="content_right">（无误：7分——三次及三次以上：0分）</div></td><td class="score"><input type="text" name="a2"/></td>
</tr>

<tr>

	<td colspan ="4" class="check_content"><div class="content_left">3、基地报销严格审查。</div><div class="content_right">（无误：7分——两次及两次以上错误：0分）</div></td><td class="score"><input type="text" name="a3"/></td>
</tr>

<tr>

	<td colspan ="4" class="check_content"><div class="content_left">4、细致做好每一次基地采购以及日常采购。</div><div class="content_right">（无误：7分——两次及两次以上错误：0分）</div></td><td class="score"><input type="text" name="a4"/></td>
</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">5、认真做好每月报销分析。</div><div class="content_right">（分析良好：7分——未分析：0分）</div></td><td class="score"><input type="text" name="a5"/></td>
</tr>
<tr>
...
<tr>
	...
	<td rowspan="3" class="zhiban">其它</td><td colspan ="4" class="check_content"><div class="content_left">1、积极参加基地、部门举办的各类活动。</div><div class="content_right">（积极参与各项活动：6分——消极对待各项活动：0分）</div></td><td class="score"><input type="text" name="d1"/></td>
</tr>

<tr>

	<td colspan ="4" class="check_content"><div class="content_left">2、与组员良好沟通，并交接工作顺利。</div><div class="content_right">（沟通良好：5分——未沟通：0分）</div></td><td class="score"><input type="text" name="d2"/></td>
</tr>
<tr>

	<td colspan ="4" class="check_content"><div class="content_left">3、与各部门资产主管经常沟通交流。</div><div class="content_right">（沟通良好：5分——未沟通：0分）</div></td><td class="score"><input type="text" name="d3"/></td>
</tr>
