...
<center>
<form action="save_to_db_shengsheng_yuangong.php" method="get">
 <?php
...
<!-- ------------------------------------------------------------------ -->
<tr>
	<td rowspan ="18" class="work_weight">工作任务</td><td rowspan="7" class="zhiban"class="zhiban">值班</td><td class="work_weight" rowspan="7">20%</td><td class="check_content_tb1" colspan="2" >1.迟到或早退十五分钟及以上扣2分/次。</td><td class="score"><input type="text"name="a1"/></td>
</tr>
<tr>
...
<tr>
	<td rowspan ="12" class="work_weight">工作态度</td><td rowspan="4"class="zhiban">积极性</td><td class="work_weight" rowspan="4" >10%</td><td class="check_content">1.工作一贯积极主动，做事从来不需要上级督促。</td><td>7-8分</td><td class="score" rowspan="4"><input type="text"name="f"/></td>
</tr>
<tr>
...
<tr>
	<td rowspan="4"class="zhiban">责任心</td><td class="work_weight" rowspan="4">10%</td><td class="check_content">1.工作十分负责，除了本职工作，还非常关心其他工作。</td><td>7-8分</td><td class="score" rowspan="4"><input type="text"name="g"/></td>
</tr>
<tr>
...
<tr>
	<td rowspan="4"class="zhiban">协作性</td><td class="work_weight" rowspan="4">10%</td><td class="check_content">1.能够主动配合、帮助同事和其他部门开展工作。</td><td>7-8分</td><td class="score" rowspan="4"><input type="text"name="h"/></td>
</tr>
<tr>
...
<!-- ---------------工作能力--------------------------------------------------- -->
<tr>
	<td rowspan ="10" class="work_weight">工作能力</td><td rowspan="4"class="zhiban">执行力</td><td class="work_weight" rowspan="4">8%</td><td class="check_content">1.没有顶撞上级现象，能完全按上级要求完成工作。</td><td>7-8分</td><td class="score" rowspan="4"><input type="text"name="i"/></td>
</tr>
<tr>
...
<tr>
	<td rowspan="3"class="zhiban">建设性</td><td class="work_weight" rowspan="3">6%</td><td class="check_content">1.主动与上层，同事交流，善于发现并提出部门工作中的问题，并积极解决。</td><td>5-6分</td><td class="score" rowspan="3"><input type="text"name="k"/></td>
</tr>
